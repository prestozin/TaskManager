...
namespace TaskManager.Infra.Migrations
{
    ...
    [Migration("20260622035406_CreateTable_Status")]
    partial class CreateTable_Status
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Core.Entities.StatusTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManager.Core.Entities.TaskItem", b =>
                {
                    b.HasOne("TaskManager.Core.Entities.StatusTask", "Status")
                        .WithMany()
